...
export default function ImageGenerator() {
  ...
  const query = async (data:any) => {
    ...
    const response = await fetch(
      ...
      {
        headers: { Authorization: "Bearer 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" },
        method: "POST",
  ...
  return (
    <div className="flex-col gap-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div className="p-2 flex gap-2 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
