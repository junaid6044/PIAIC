import { cardType } from "@/app/types/commonTypes";

export default function featureCard({ color, title, description }: cardType) {
  return (
    <div className="group relative mx-2 my-3 flex min-h-[300px] w-auto cursor-pointer flex-col items-center justify-evenly overflow-hidden rounded-lg transition-all duration-500 hover:scale-110 lg:mx-5" style={{ boxShadow: 'rgba(0, 0, 0, 0.24) 0px 3px 14px' }}>
      <div className={`absolute -left-10 -top-10 z-0 h-20 w-20 transition-all duration-700 group-hover:scale-[20]`} style={{ borderRadius: '50%', backgroundColor: color }}></div>
