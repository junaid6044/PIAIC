      ...
      <section className="campus">
        ...
        <div className="row">
          <div className="campus-col">
            <img src="../public/assert/Campus1.png" alt="" />
            <div className="layer">
              <h3>DELHI</h3>
            </div>
          </div>
          <div className="campus-col">
            <img src="../public/assert/Campus2.png" alt="" />
            <div className="layer">
              <h3>HYDERABAD</h3>
            </div>
          </div>
          <div className="campus-col">
            <img src="../public/assert/Campus3.png" alt="" />
            <div className="layer">
              <h3>MUMBAI</h3>
            </div>
          </div>
      ...
      <section className="facilities">
        ...
        <div className="row">
          <div className="facilities-col">
            <img src="../public/assert/libary.png" alt="" />
            <h3>Best Libary</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio omnis asperiores atque aperiam.</p>
          </div>
          <div className="facilities-col">
            <img src="../public/assert/playground.png" alt="" />
            <h3>Athletics</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio omnis asperiores atque aperiam.</p>
          </div>
          <div className="facilities-col">
            <img src="../public/assert/food.png" alt="" />
      ...
      <section className="testimonials">
        ...
        <div className="row">
          <div className="testimonials-col">
            <img src="../public/assert/user.png" alt="oo.." />
            <div>
